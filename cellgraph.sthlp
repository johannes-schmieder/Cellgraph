...
cellgraph - Creates graphs similar to tables that are produced with tabstat. For example in a panel dataset on individual workers it could produce a graph of mean wages by year and gender.
